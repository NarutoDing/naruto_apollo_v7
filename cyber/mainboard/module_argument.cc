...
void ModuleArgument::ParseArgument(const int argc, char* const argv[]) {
  ///home/naruto/build-naruto_apollo-Desktop_Qt_5_14_1_GCC_64bit-Debug/cyber/mainboard/mainboard
  //basename获取 "mainboard"
  //binary_name_ = "mainboard"
...
void ModuleArgument::GetOptions(const int argc, char* const argv[]) {
  ...
  //获取命令行的全部内容
  ///home/naruto/build-naruto_apollo-Desktop_Qt_5_14_1_GCC_64bit-Debug/cyber/mainboard/mainboard 
  //-d /home/naruto/naruto_apollo/modules/planning/dag/planning.dag
  std::string cmd("");
