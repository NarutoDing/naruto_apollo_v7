...
struct _FPGA_SYSTEM {
        ...
        volatile INT8   irigBYearMode;     /* 0x16900 */
        volatile INT8   irigBYear;         /* 0x16901 */
        INT8            reserved6[2];      /* 0x16902-0x16903 */
        volatile UINT32 irigBTimeStart;    /* 0x16904 */
        volatile UINT32 irigBSyncMode;     /* 0x16908 */ /* Write 0x0001 to increase tolerance */
};
