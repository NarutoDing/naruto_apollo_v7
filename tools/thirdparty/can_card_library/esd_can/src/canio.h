...
**
**      Copyright (c) 2001 - 2020 by esd electronics gmbh
**
...
#define CANIO_ID_LAST             (CANIO_ID_BASE+CANIO_IDS-1)
 ...
 /* LIN-id-values */
#define CANIO_LIN_IDS             0x40      /* range of LIN-IDs */
#define CANIO_LIN_ID_BASE         0x00000000
#define CANIO_LIN_ID_LAST         (CANIO_LIN_ID_BASE+CANIO_LIN_IDS-1)
...
#define CANIO_CANCTL_ESDLIN       0x10
...
#define IOCTL_ESDCAN_GET_TX_MESSAGES           _IOR  (IOCTL_BASE, 63, IOCTL_ARG*)
...
#define IOCTL_LIN_MASTER_SEL                   _IOW  (IOCTL_BASE,113, IOCTL_ARG*)

#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE    _IOW  (IOCTL_BASE,114, IOCTL_ARG*)
#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_T  _IOW  (IOCTL_BASE,115, IOCTL_ARG*)
#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_X  _IOW  (IOCTL_BASE,116, IOCTL_ARG*)

#define IOCTL_ESDCAN_GET_HW_TIMESTAMP          _IOR  (IOCTL_BASE,117, IOCTL_ARG*)
#define IOCTL_ESDCAN_GET_HW_TIMESTAMP_EX       _IOR  (IOCTL_BASE,118, IOCTL_ARG*)
...
#define IOCTL_ESDCAN_GET_TX_MESSAGES_32            GEN_IOCTL32(IOCTL_ESDCAN_GET_TX_MESSAGES)
...
#define IOCTL_LIN_MASTER_SEL_32                    GEN_IOCTL32(IOCTL_LIN_MASTER_SEL)

#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_32     GEN_IOCTL32(IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE)
#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_T_32   GEN_IOCTL32(IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_T)
#define IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_X_32   GEN_IOCTL32(IOCTL_ESDCAN_TX_OBJ_AUTOANSWER_ONCE_X)

#endif  /* #if defined(PLATFORM_64BIT) */
...
typedef struct _CAN_INFO {
        ...
        uint8_t  align[2];                    /* Reserved for alignment               */
        uint64_t osif_ts_freq;                /* Frequency of OSIF timestamp tick     */
        uint8_t  reserved2[32];               /* Reserved for future use              */
} CAN_INFO;

typedef struct _CAN_HW_TIMESTAMP {
        uint64_t ts[5];             /* Size of array may be reduced in the future */
} CAN_HW_TIMESTAMP;
...
#define CANIO_MODE_LIN               0x08000000 /* MARK as LIN handle                       */
...
#define FEATURE_TX_INHIBIT       (1<<18) /*! Tx inhibit support                                           */
#define FEATURE_LIN              (1<<27) /*! Feature/mode flag for LIN                                    */
...
#define CANIO_NO_CAN_CAPABILITY      (CANIO_ERRNO_BASE+25)
#define CANIO_NO_LIN_CAPABILITY      (CANIO_ERRNO_BASE+26)
