...
# elif (LINUX_VERSION_CODE < KERNEL_VERSION(2,4,8)) || (LINUX_VERSION_CODE >= KERNEL_VERSION(4,15,0))
/*
 ...
 * STM: Since kernel version 4.15-rc2 the %p format needs a suffix "x" to
 *      print pointer contents as unhashed plain text. To work around this
 *      deviation from standard vsnprintf() behaviour fall back to our
 ...
 */
# if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,18) && (LINUX_VERSION_CODE < KERNEL_VERSION(4,15,0))
